...
`)],-1),N=n("img",{src:d},null,-1),V=n("h4",null,"TypeScript\u4E2D\u7C7B\u7684\u7528\u6CD5",-1),P=n("h5",null,"public private\u548Cpretected",-1),B=n("p",null,"TypeScript\u53EF\u4EE5\u4F7F\u7528\u4E09\u79CD\u4FEE\u9970\u7B26\uFF0C\u5206\u522B\u662Fpublic\u3001private\u548Cprotected",-1),j=n("p",null,"\u4E0B\u9762\u4E3E\u4E00\u4E9B\u4F8B\u5B50\uFF1A",-1),O=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal{
  public name
...
a.name = 'Tom'
console.log(a.name)
`)],-1),I=n("p",null,"\u4E0A\u9762\u7684\u4F8B\u5B50\u4E2D\uFF0Cname\u88AB\u8BBE\u7F6E\u4E3A\u4E86public\uFF0C\u6240\u4EE5\u76F4\u63A5\u8BBF\u95EE\u5B9E\u4F8B\u7684name\u5C5E\u6027\u662F\u5141\u8BB8\u7684",-1),R=n("p",null,"\u5F88\u591A\u65F6\u5019\uFF0C\u6211\u4EEC\u5E0C\u671B\u6709\u7684\u5C5E\u6027\u662F\u65E0\u6CD5\u76F4\u63A5\u5B58\u53D6\u7684\uFF0C\u8FD9\u65F6\u5019\u5C31\u53EF\u4EE5\u7528private\u4E86",-1),Z=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal {
  private name
  public constructor(name){
    this.name = name
  }
...
`)],-1),q=n("p",null,"\u9700\u8981\u6CE8\u610F\u7684\u662F\uFF0CTypeScript \u7F16\u8BD1\u4E4B\u540E\u7684\u4EE3\u7801\u4E2D\uFF0C\u5E76\u6CA1\u6709\u9650\u5236 private \u5C5E\u6027\u5728\u5916\u90E8\u7684\u53EF\u8BBF\u95EE\u6027\u3002",-1),z=n("p",null,"\u4E0A\u9762\u7684\u4F8B\u5B50\u7F16\u8BD1\u540E\u7684\u4EE3\u7801\u662F\uFF1A",-1),G=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`var Animal = (function () {
...
console.log(a.name);
a.name = 'Tom';
`)],-1),K=n("p",null,"\u4F7F\u7528 private \u4FEE\u9970\u7684\u5C5E\u6027\u6216\u65B9\u6CD5\uFF0C\u5728\u5B50\u7C7B\u4E2D\u4E5F\u662F\u4E0D\u5141\u8BB8\u8BBF\u95EE\u7684\uFF1A",-1),L=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal {
  private name;
  public constructor(name) {
    this.name = name;
  }
...
`)],-1),Q=n("p",null,"\u800C\u5982\u679C\u662F\u7528 protected \u4FEE\u9970\uFF0C\u5219\u5141\u8BB8\u5728\u5B50\u7C7B\u4E2D\u8BBF\u95EE\uFF1A",-1),U=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal {
  protected name;
  public constructor(name) {
    this.name = name;
  }
...
`)],-1),W=n("p",null,"\u5F53\u6784\u9020\u51FD\u6570\u4FEE\u9970\u4E3A private \u65F6\uFF0C\u8BE5\u7C7B\u4E0D\u5141\u8BB8\u88AB\u7EE7\u627F\u6216\u8005\u5B9E\u4F8B\u5316\uFF1A",-1),X=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal {
  public name;
...
`)],-1),Y=n("p",null,"\u5F53\u6784\u9020\u51FD\u6570\u4FEE\u9970\u4E3A protected \u65F6\uFF0C\u8BE5\u7C7B\u53EA\u5141\u8BB8\u88AB\u7EE7\u627F\uFF1A",-1),nn=n("pre",null,[n("code",{class:"language-JavaScript","v-pre":"true"},`class Animal {
  public name;
