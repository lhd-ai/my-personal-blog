...
`)],-1);function N(t,n){return r(),u(c,null,[g,v,b,x,P,V,j,k,D,I,O,R,A,T,w,y,B,E,F,M],64)}const a={render:N};a.__hmrId="D:/lhdtext/vue3/my-personal-blog/src/markdown/FontEnd/vue3/Pinia/store.md";const $=d("main",()=>{const t=_(0);function n(){t.value++}return{count:t,increment:n}}),z=$,H={components:{MarkDownComponent:a},setup(){const t=z(),{count:n}=m(t),{increment:s}=t;return{count:n,increment:s}}};function K(t,n,s,o,L,U){const i=h("MarkDownComponent");return r(),u(c,null,[e("div",null,f(o.count),1),e("button",{onClick:n[0]||(n[0]=(...l)=>o.increment&&o.increment(...l))},"\u6309\u94AE"),e("article",null,[C(i)])],64)}const q=S(H,[["render",K]]);export{q as default};
