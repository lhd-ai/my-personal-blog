...
`)],-1),x=e("p",null,"\u76F8\u5BF9\u4E8E",-1),j=e("pre",null,[e("code",{class:"language-javascript","v-pre":"true"},`interface Alarm{
  price: number
  weight: number
}
`)],-1),w=e("p",null,"\u6CE8\u610F\uFF0C\u5408\u5E76\u7684\u5C5E\u6027\u7684\u7C7B\u578B\u5FC5\u987B\u662F\u552F\u4E00\u7684",-1),A=e("pre",null,[e("code",{class:"language-javascript","v-pre":"true"},`interface Alarm{
  price:number
}
interface Alarm{
  price: number
...
`)],-1),$=e("h4",null,"\u7C7B\u7684\u5408\u5E76",-1),B=e("p",null,"\u7C7B\u7684\u5408\u5E76\u4E0E\u63A5\u53E3\u7684\u5408\u5E76\u89C4\u5219\u4E00\u81F4",-1);function F(s,a){return n(),r(c,null,[p,m,_,d,g,h,b,f,v,x,j,w,A,k,y,C,M,V,$,B],64)}const t={render:F};t.__hmrId="D:/lhdtext/vue3/my-personal-blog/src/markdown/FontEnd/Ts/declarationMerge.md";const N={components:{MarkdownComponent:t},setup(){}};function S(s,a,E,T,q,D){const o=l("MarkdownComponent");return n(),r("article",null,[u(o)])}const R=i(N,[["render",S]]);export{R as default};
