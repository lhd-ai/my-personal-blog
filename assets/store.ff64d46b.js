...
`)],-1);function N(t,n){return r(),u(c,null,[g,v,b,x,P,V,k,j,A,D,I,O,R,T,w,y,B,E,F,M],64)}const a={render:N};a.__hmrId="D:/lhdtext/vue3/my-personal-blog/src/markdown/FontEnd/vue3/Pinia/store.md";const z=d("main",()=>{const t=_(0);function n(){t.value++}return{count:t,increment:n}}),$=z,q={components:{MarkDownComponent:a},setup(){const t=$(),{count:n}=m(t),{increment:s}=t;return{count:n,increment:s}}};function H(t,n,s,o,K,L){const i=h("MarkDownComponent");return r(),u(c,null,[e("div",null,f(o.count),1),e("button",{onClick:n[0]||(n[0]=(...l)=>o.increment&&o.increment(...l))},"\u6309\u94AE"),e("article",null,[C(i)])],64)}const G=S(q,[["render",H]]);export{G as default};
