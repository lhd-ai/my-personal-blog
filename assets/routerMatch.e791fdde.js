...
`)],-1),k=e("p",null,"\u8FD9\u5C06\u4E3A\u4F60\u63D0\u4F9B\u4E00\u4E2A\u53C2\u6570\u6570\u7EC4\uFF0C\u800C\u4E0D\u662F\u4E00\u4E2A\u5B57\u7B26\u4E32\uFF0C\u5E76\u4E14\u5728\u4F7F\u7528\u547D\u540D\u8DEF\u7531\u65F6\u4E5F\u9700\u8981\u4F60\u4F20\u9012\u4E00\u4E2A\u6570\u7EC4\uFF1A",-1),x=e("pre",null,[e("code",{class:"language-js","v-pre":"true"},`// \u7ED9\u5B9A { path: '/:chapters*', name: 'chapters' },
...
router.resolve({ name: 'chapters', params: { chapters: [] } }).href
// \u629B\u51FA\u9519\u8BEF\uFF0C\u56E0\u4E3A \`chapters\` \u4E3A\u7A7A 
`)],-1),b=e("p",null,"\u8FD9\u4E9B\u4E5F\u53EF\u4EE5\u901A\u8FC7\u5728\u53F3\u62EC\u53F7\u540E\u6DFB\u52A0\u5B83\u4EEC\u4E0E\u81EA\u5B9A\u4E49\u6B63\u5219\u7ED3\u5408\u4F7F\u7528\uFF1A",-1),R=e("pre",null,[e("code",{class:"language-js","v-pre":"true"},`const routes = [
  // \u4EC5\u5339\u914D\u6570\u5B57
  // \u5339\u914D /1, /1/2, \u7B49
  { path: '/:chapters(\\\\d+)+' },
  // \u5339\u914D /, /1, /1/2, \u7B49
...
`)],-1),$=e("p",null,"\u8BF7\u6CE8\u610F\uFF0C* \u5728\u6280\u672F\u4E0A\u4E5F\u6807\u5FD7\u7740\u4E00\u4E2A\u53C2\u6570\u662F\u53EF\u9009\u7684\uFF0C\u4F46 ? \u53C2\u6570\u4E0D\u80FD\u91CD\u590D\u3002",-1);function B(r,o){return s(),t(u,null,[h,d,_,i,m,v,g,f,I,j,w,N,k,x,b,R,C,M,U,y,D,V,$],64)}const n={render:B};n.__hmrId="D:/lhdtext/vue3/my-personal-blog/src/markdown/FontEnd/vue3/Router/routerMatch.md";const F={components:{MarkDownComponent:n},setup(){}};function E(r,o,L,z,H,S){const a=p("MarkDownComponent");return s(),t("article",null,[l(a)])}const Z=c(F,[["render",E]]);export{Z as default};
